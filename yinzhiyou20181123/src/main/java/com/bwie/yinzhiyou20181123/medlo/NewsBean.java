package com.bwie.yinzhiyou20181123.medlo;
...
public class NewsBean {
    ...
    public static class DataBean {
        ...
        public DataBean(String name, String title, String thumbnail_pic_s, String thumbnail_pic_s02, String thumbnail_pic_s03) {
